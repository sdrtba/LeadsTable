...
export const LeadModal = ({active, handleModal, token, id, setErrorMessage}) => {
    ...
    const handleUpdatelead = async (e) => {
        ...
        const response = await fetch(`/api/leads/${id}`, requestOptions)
        if (!response.ok) {
            setErrorMessage("Something went wrong in update")
        } else {
            cleanFormData()
            handleModal()
        }
        ...
        <div className={`modal ${active && "is-active"}`}>
            ...
            <div className="modal-card">
                <header className="modal-card-head has-background-primary-light">
                    <h1 className="modal-card-title has-text-black">
                ...
                <section className="modal-card-body">
                    <form>
                        <div className="field">
                            ...
                            <div className="control">
                                <input type="email" placeholder="Enter company" value={company} onChange={(e) => setCompany(e.target.value)} className="input"/>
                            </div>
                            <div className="control">
